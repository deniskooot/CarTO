...
public class CarUser {
  ...
  */
  @OneToMany(
      ...
      orphanRemoval = false) // OneToMany Car reference, Car is owner reference (Car side is Many).
  @JsonIgnore
  ...
  public String toString() {
    return "CarUser{" + "id=" + id + ", name='" + name + '\'' + '}';
  }
  ...
  public boolean equals(Object o) {
    ...
    return id == carUser.id
        && Objects.equals(name, carUser.name)
        && Objects.equals(cars, carUser.cars);
  }
