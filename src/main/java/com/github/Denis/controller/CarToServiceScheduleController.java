...
public class CarToServiceScheduleController {
  ...
  @Transactional
  public int saveNewCarToServiceSchedule(
      @RequestBody @Valid CarToServiceScheduleDTO carToServiceScheduleDTO) {
  ...
  public List<ScheduleListDTO> getTasks(
    ...
    return carToServiceScheduleService.getTaskList(
        car_id, schedule_perspective_mileage_or_year, schedule_perspective_value, show_required);
  }
}
